...
export function CategoryHeader({ title }: CategoryHeaderProps) {
  ...
  return (
    <header
      className={clsx(
        "flex items-center justify-between w-full h-14 bg-white border-gray-200 border-b-[1px] sticky top-0 z-header transition-transform duration-300 ease-linear",
